        ...
        return (
            <div>
                <p className={'info__description'}>
                    All tracks have been composed just on one Nintendo Gameboy Original and{' '}
                    <a rel="noopener noreferrer" href={lsdjLink} className={"info__link"} target={"_blank"}>LittleSoundDj</a> cartridge.
                    <br />
